...
public :
   ...
   std::map<unsigned int, TH1*> _hmap_RM;
   std::map<unsigned int, TH1*> _hmap_RM_1;
   ...
   // Topology
   std::map<unsigned int, TH1*> _hmap_MT_on_pT_lead;
   std::map<unsigned int, TH1*> _hmap_jet_met_Dphi;
   std::map<unsigned int, TH1*> _hmap_transverse_mass;
   std::map<unsigned int, TH1*> _hmap_Transverse_Mass;
   std::map<unsigned int, TH1*> _hmap_Transverse_Mass_1;
   ...
   std::map<unsigned int, TH1*> _hmap_MET;
   std::map<unsigned int, TH1*> _hmap_MET_1;
   std::map<unsigned int, TH1*> _hmap_met_HT;
   std::map<unsigned int, TH1*> _hmap_MET_HT;
   std::map<unsigned int, TH1*> _hmap_MET_1_HT;
   std::map<unsigned int, TH1*> _hmap_met_sqrtHT;
   std::map<unsigned int, TH1*> _hmap_MET_sqrtHT;
   std::map<unsigned int, TH1*> _hmap_MET_1_sqrtHT;
   ...
   std::map<unsigned int, TH2*> _hmap_jpT_MET;
};
